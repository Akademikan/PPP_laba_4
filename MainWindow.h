...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// CreateTable_btn
			// 
			this->CreateTable_btn->Location = System::Drawing::Point(361, 12);
			this->CreateTable_btn->Margin = System::Windows::Forms::Padding(4);
			this->CreateTable_btn->Name = L"CreateTable_btn";
			this->CreateTable_btn->Size = System::Drawing::Size(100, 28);
			this->CreateTable_btn->TabIndex = 2;
			this->CreateTable_btn->Text = L"Ввод";
			...
			this->Create_label->Location = System::Drawing::Point(13, 18);
			this->Create_label->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->Create_label->Name = L"Create_label";
			this->Create_label->Size = System::Drawing::Size(117, 16);
			this->Create_label->TabIndex = 1;
			this->Create_label->Text = L"Создание/выбор\r\n";
			this->Create_label->Click += gcnew System::EventHandler(this, &MainWindow::label1_Click);
			// 
			// Table_txt
			// 
			this->Table_txt->Location = System::Drawing::Point(138, 15);
			this->Table_txt->Margin = System::Windows::Forms::Padding(4);
			this->Table_txt->MaxLength = 16;
			this->Table_txt->Name = L"Table_txt";
			this->Table_txt->Size = System::Drawing::Size(215, 22);
			this->Table_txt->TabIndex = 0;
			this->Table_txt->TextChanged += gcnew System::EventHandler(this, &MainWindow::Table_txt_TextChanged);
			// 
			// Tariff_txt_add
			// 
			this->Tariff_txt_add->Location = System::Drawing::Point(16, 79);
			this->Tariff_txt_add->Margin = System::Windows::Forms::Padding(4);
			this->Tariff_txt_add->Name = L"Tariff_txt_add";
			this->Tariff_txt_add->Size = System::Drawing::Size(219, 22);
			this->Tariff_txt_add->TabIndex = 3;
			// 
			// PerMin_txt_add
			// 
			this->PerMin_txt_add->Location = System::Drawing::Point(16, 113);
			this->PerMin_txt_add->Margin = System::Windows::Forms::Padding(4);
			this->PerMin_txt_add->Name = L"PerMin_txt_add";
			this->PerMin_txt_add->Size = System::Drawing::Size(219, 22);
			this->PerMin_txt_add->TabIndex = 4;
			// 
			// ID_txt_record
			// 
			this->ID_txt_record->Location = System::Drawing::Point(433, 78);
			this->ID_txt_record->Margin = System::Windows::Forms::Padding(4);
			this->ID_txt_record->Name = L"ID_txt_record";
			this->ID_txt_record->Size = System::Drawing::Size(219, 22);
			this->ID_txt_record->TabIndex = 5;
			// 
			// label1
			// 
			this->label1->AutoSize = true;
			this->label1->Location = System::Drawing::Point(244, 82);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(59, 16);
			this->label1->TabIndex = 6;
			this->label1->Text = L"Тарифа";
			this->label1->Click += gcnew System::EventHandler(this, &MainWindow::label1_Click_1);
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(244, 117);
			this->label2->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(87, 16);
			this->label2->TabIndex = 7;
			this->label2->Text = L"Цена за мин";
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(660, 82);
			...
			// add_btn
			// 
			this->add_btn->Location = System::Drawing::Point(16, 149);
			this->add_btn->Margin = System::Windows::Forms::Padding(4);
			this->add_btn->Name = L"add_btn";
			this->add_btn->Size = System::Drawing::Size(220, 28);
			...
			this->label4->Location = System::Drawing::Point(60, 50);
			this->label4->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(138, 16);
			this->label4->TabIndex = 10;
			this->label4->Text = L"Добавление данных";
			this->label4->Click += gcnew System::EventHandler(this, &MainWindow::label4_Click);
			// 
			// TariffName_txt_search
			// 
			this->TariffName_txt_search->Location = System::Drawing::Point(19, 221);
			this->TariffName_txt_search->Margin = System::Windows::Forms::Padding(4);
			this->TariffName_txt_search->Name = L"TariffName_txt_search";
			this->TariffName_txt_search->Size = System::Drawing::Size(219, 22);
			this->TariffName_txt_search->TabIndex = 11;
			// 
			// TariffName_search_btn
			// 
			this->TariffName_search_btn->Location = System::Drawing::Point(250, 218);
			this->TariffName_search_btn->Margin = System::Windows::Forms::Padding(4);
			this->TariffName_search_btn->Name = L"TariffName_search_btn";
			this->TariffName_search_btn->Size = System::Drawing::Size(151, 28);
			this->TariffName_search_btn->TabIndex = 12;
			this->TariffName_search_btn->Text = L"Тариф";
			...
			// Revenue_txt_search
			// 
			this->Revenue_txt_search->Location = System::Drawing::Point(19, 313);
			this->Revenue_txt_search->Margin = System::Windows::Forms::Padding(4);
			this->Revenue_txt_search->Name = L"Revenue_txt_search";
			this->Revenue_txt_search->Size = System::Drawing::Size(219, 22);
			this->Revenue_txt_search->TabIndex = 13;
			// 
			// PerMin_txt_search
			// 
			this->PerMin_txt_search->Location = System::Drawing::Point(19, 263);
			this->PerMin_txt_search->Margin = System::Windows::Forms::Padding(4);
			this->PerMin_txt_search->Name = L"PerMin_txt_search";
			this->PerMin_txt_search->Size = System::Drawing::Size(219, 22);
			this->PerMin_txt_search->TabIndex = 14;
			// 
			// PerMin_search_btn
			// 
			this->PerMin_search_btn->Location = System::Drawing::Point(250, 260);
			this->PerMin_search_btn->Margin = System::Windows::Forms::Padding(4);
			this->PerMin_search_btn->Name = L"PerMin_search_btn";
			this->PerMin_search_btn->Size = System::Drawing::Size(151, 28);
			this->PerMin_search_btn->TabIndex = 15;
			this->PerMin_search_btn->Text = L"Цена за мин";
			...
			// Revenue_search_btn
			// 
			this->Revenue_search_btn->Location = System::Drawing::Point(250, 310);
			this->Revenue_search_btn->Margin = System::Windows::Forms::Padding(4);
			this->Revenue_search_btn->Name = L"Revenue_search_btn";
			this->Revenue_search_btn->Size = System::Drawing::Size(151, 28);
			this->Revenue_search_btn->TabIndex = 16;
			this->Revenue_search_btn->Text = L"Стоимость";
			...
			this->label5->Location = System::Drawing::Point(106, 190);
			...
			this->label6->Location = System::Drawing::Point(492, 233);
			this->label6->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(72, 16);
			this->label6->TabIndex = 18;
			this->label6->Text = L"Удаление";
			this->label6->Click += gcnew System::EventHandler(this, &MainWindow::label6_Click);
			// 
			// Id_txt_delete
			// 
			this->Id_txt_delete->Location = System::Drawing::Point(461, 263);
			this->Id_txt_delete->Margin = System::Windows::Forms::Padding(4);
			this->Id_txt_delete->Name = L"Id_txt_delete";
			this->Id_txt_delete->Size = System::Drawing::Size(132, 22);
			this->Id_txt_delete->TabIndex = 19;
			// 
			// label7
			// 
			this->label7->AutoSize = true;
			this->label7->Location = System::Drawing::Point(601, 266);
			...
			// Delete_btn
			// 
			this->Delete_btn->Location = System::Drawing::Point(461, 307);
			this->Delete_btn->Margin = System::Windows::Forms::Padding(4);
			this->Delete_btn->Name = L"Delete_btn";
			this->Delete_btn->Size = System::Drawing::Size(133, 28);
			...
			this->dataGridView1->Location = System::Drawing::Point(-4, 383);
			this->dataGridView1->Margin = System::Windows::Forms::Padding(4);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(960, 303);
			...
			this->refresh->Location = System::Drawing::Point(815, 202);
			this->refresh->Margin = System::Windows::Forms::Padding(4);
			this->refresh->Name = L"refresh";
			this->refresh->Size = System::Drawing::Size(85, 47);
			this->refresh->TabIndex = 24;
			this->refresh->Text = L"Обновить данные";
			...
			this->close_btn->Location = System::Drawing::Point(815, 275);
			this->close_btn->Margin = System::Windows::Forms::Padding(4);
			this->close_btn->Name = L"close_btn";
			this->close_btn->Size = System::Drawing::Size(85, 47);
			this->close_btn->TabIndex = 27;
			this->close_btn->Text = L"Выход";
			this->close_btn->UseVisualStyleBackColor = true;
			this->close_btn->Click += gcnew System::EventHandler(this, &MainWindow::button1_Click);
			// 
			// to_txt_btn
			// 
			this->to_txt_btn->Location = System::Drawing::Point(815, 130);
			this->to_txt_btn->Margin = System::Windows::Forms::Padding(4);
			this->to_txt_btn->Name = L"to_txt_btn";
			this->to_txt_btn->Size = System::Drawing::Size(85, 47);
			this->to_txt_btn->TabIndex = 27;
			this->to_txt_btn->Text = L"Сохранить";
			...
			// Min_txt_Record
			// 
			this->Min_txt_Record->Location = System::Drawing::Point(433, 113);
			this->Min_txt_Record->Margin = System::Windows::Forms::Padding(4);
			this->Min_txt_Record->Name = L"Min_txt_Record";
			this->Min_txt_Record->Size = System::Drawing::Size(219, 22);
			this->Min_txt_Record->TabIndex = 28;
			// 
			// label8
			// 
			this->label8->AutoSize = true;
			this->label8->Location = System::Drawing::Point(660, 116);
			this->label8->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(79, 16);
			this->label8->TabIndex = 29;
			this->label8->Text = L"Кол-во мин\r\n";
			// 
			// RecordMinutes_button
			// 
			this->RecordMinutes_button->Location = System::Drawing::Point(433, 149);
			this->RecordMinutes_button->Margin = System::Windows::Forms::Padding(4);
			this->RecordMinutes_button->Name = L"RecordMinutes_button";
			this->RecordMinutes_button->Size = System::Drawing::Size(220, 28);
			...
			this->ClientSize = System::Drawing::Size(948, 678);
